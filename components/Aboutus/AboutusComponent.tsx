    ...
    <div className={'sm:mx-6 md:mx-12 lg:mx-24'}>
      <div className={"flex flex-col lg:flex-row justify-center mx-auto"}>
        ...
        >
          ...
          <p className={"text-center text-xl"}>
                ...
                of it as we do.</p>
          <button style={{ fontFamily: 'Exan-regular' }} type="button" 
          className="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:ring-cyan-300 font-medium rounded-lg text-lg px-5 py-2.5 text-center mr-2 my-4">Click here to see more about us</button>
        </div>
        ...
        >
          ...
          <p className={"text-center text-xl"}>At InfiniteSolutions, Our team has combined experience in taking applications
          from idea to a finished masterpiece. From designing the
        ...
        also pride ourselves on writing innovative smart contracts to suit your unique business idea.</p>
          <button style={{ fontFamily: 'Exan-regular' }} type="button" 
          className="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:ring-cyan-300 font-medium rounded-lg text-lg px-5 py-2.5 text-center mr-2 my-4">Click here to see past projects</button>
        </div>
      </div>
      ...
      >
        ...
        <p className={'text-center text-xl mx-4 px-6'}>
          We offer many services in web3 development, community management, business consulting,
           web application design and marketing. Whether the task involves developing new crypto applications
            such as regular token contracts, NFT collections, DAO/governance contracts, staking platforms, swaps, etc.
             We can meet all your development needs. If you need help managing your community or marketing,
              we can hire a community moderator for your social media app or develop a marketing strategy
               to reach thousands of people with your app.  </p>
          <button style={{ fontFamily: 'Exan-regular' }} type="button" 
          className="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:ring-cyan-300 font-medium rounded-lg text-lg px-5 py-2.5 text-center mr-2 my-4">Click here for a quote</button>
      </div>
      </div>
