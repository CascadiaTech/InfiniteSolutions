      ...
      <div className={"sm:mx-6 md:mx-12 lg:mx-24"}>
        <div className={"flex flex-col lg:flex-row justify-center mx-auto"}>
          ...
          >
            ...
            <p className={"text-center text-xl"}>
              What started as a passion for web3 and solving problems has turned
              into an international team of developers seeking to create the
              next future of finance and consumer spending. We are a team who
              love to solve hard problems, and to stretch the bounds of what can
              be done. Web3 changes the form of the Internet, there is a change
              in the air in the way consumers will spend their money. Consumers
              spend money to preserve their identity, whether its donating to a
              charity or purchasing a baseball shirt. Our world is getting
              increasingly digital, as are our identities. We see NFTs and web3
              as a reaction to that. A unique opportunity to capitalize on the
              future is in our hands, let us help you take advantage of it as we
              do.
            </p>
          ...
          >
            ...
            <p className={"text-center text-xl"}>
              ...
              the initial concept, to deploying to your production environment,
              we have done it. Our specialization is in Web3 projects, our
              preferred front-end language ReactJS is used throughout the
              industry so your app can scale. We also pride ourselves on writing
              innovative smart contracts to suit your unique business idea.
            </p>
        ...
        >
          ...
          <p className={"text-center text-xl mx-4 px-6"}>
            ...
            the task involves developing new crypto applications such as regular
            token contracts, NFT collections, DAO/governance contracts, staking
            platforms, swaps, etc. We can meet all your development needs. If
            you need help managing your community or marketing, we can hire a
            community moderator for your social media app or develop a marketing
            strategy to reach thousands of people with your app.{" "}
          </p>
